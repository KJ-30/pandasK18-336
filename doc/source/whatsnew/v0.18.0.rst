...
performed with the ``Resampler`` objects with :meth:`~pandas.api.typing.Resampler.bfill`,
:meth:`~pandas.api.typing.Resampler.ffill`, ``fillna`` and :meth:`~pandas.api.typing.Resampler.asfreq` methods.
